...
* canvasAppName - (Required) This is used by the WebResource to determine which Canvas App to open.  To get the name of your App open the maker portal and look at the Name field for your App. ![Canvas App Name]()
...
Then i create a button to Launch the new app in another tab.
![Launch App]()
